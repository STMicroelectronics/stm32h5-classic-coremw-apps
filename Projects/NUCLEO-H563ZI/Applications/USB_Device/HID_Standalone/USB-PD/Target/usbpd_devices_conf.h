...
#define UCPDDMA_INSTANCE1_CLOCKENABLE_RX  LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPDMA1)

#define UCPDDMA_INSTANCE0_DMA_RX  GPDMA1
#define UCPDDMA_INSTANCE1_DMA_RX  GPDMA1

#define UCPDDMA_INSTANCE0_REQUEST_RX   LL_GPDMA1_REQUEST_UCPD1_RX
#define UCPDDMA_INSTANCE1_REQUEST_RX   LL_GPDMA1_REQUEST_UCPD1_RX
...
#define UCPDDMA_INSTANCE1_CHANNEL_RX   GPDMA1_Channel2
...
#define UCPDDMA_INSTANCE1_CLOCKENABLE_TX  LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPDMA1)

#define UCPDDMA_INSTANCE0_DMA_TX  GPDMA1
#define UCPDDMA_INSTANCE1_DMA_TX  GPDMA1

#define UCPDDMA_INSTANCE0_REQUEST_TX   LL_GPDMA1_REQUEST_UCPD1_TX
#define UCPDDMA_INSTANCE1_REQUEST_TX   LL_GPDMA1_REQUEST_UCPD1_TX
...
#define UCPDFRS_INSTANCE0_FRSCC2  do{                                                                  \
                                     ...
                                     LL_GPIO_SetAFPin_0_7(GPIOB, LL_GPIO_PIN_12, LL_GPIO_AF_6);         \
                                    } while(0)
