...
#define FLASH_DESC_STR      "@Internal Flash   /0x08000000/4*8Ka,252*8Kg"
...
uint16_t FLASH_If_Erase(uint32_t Add)
{
  ...
  eraseinitstruct.Sector = startpage;
...
static uint32_t GetPage(uint32_t Address)
{
  ...
  {
    page = (Address - (FLASH_BASE + FLASH_BANK_SIZE)) / FLASH_SECTOR_SIZE;
  }
