...
static void InitThread_Entry(void *argument);
...
int main(void)
{
  ...
  printf("UDPTCP Echo Server Netconn RTOS Application \r\n");
  ...
  /* Init thread */
  InitThreadHandle = osThreadNew(InitThread_Entry, NULL, &InitThread_attributes);
