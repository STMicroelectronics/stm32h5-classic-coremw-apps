...
void MX_USB_HOST_Init(void)
{
  ...
  USBH_UsrLog(" **** USB DRD FS Host **** \n");
  USBH_UsrLog("USB Host library started.\n");
  USBH_UsrLog("Starting DualClass Application");
...
void MX_USB_HOST_Process(void)
{
  ...
  if (hUsbHostFS.pActiveClass == USBH_MSC_CLASS)
  {
    /* MSC Application Process */
    MSC_Process();
  }
  else if (hUsbHostFS.pActiveClass == USBH_HID_CLASS)
  {
