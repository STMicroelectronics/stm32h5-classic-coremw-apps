...
#endif /* USE_HAL_PCD_REGISTER_CALLBACKS */
{
      ...
      (((USBD_HandleTypeDef*)hpcd->pData)->dev_old_state == USBD_STATE_CONFIGURED))
  {
    ...
    /* Select Stop 0 mode */
    MODIFY_REG(PWR->PMCR, PWR_PMCR_LPMS, 0U);
    /* Set SLEEPDEEP bit of Cortex System Control Register. */
    ...
    __HAL_RCC_USB_CLK_SLEEP_ENABLE();
    /* Stop 1 mode */
    MODIFY_REG(PWR->PMCR, PWR_PMCR_LPMS, PWR_PMCR_LPMS_Msk);
    /* Set SLEEPDEEP bit of Cortex System Control Register. */
    SCB->SCR |= (uint32_t)(SCB_SCR_SLEEPONEXIT_Msk);
    HAL_PWR_EnableSleepOnExit();
#endif
...
USBD_StatusTypeDef USBD_LL_Init(USBD_HandleTypeDef *pdev)
{
  ...
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData, 0x00, PCD_SNG_BUF, 0x14);
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData, 0x80, PCD_SNG_BUF, 0x54);
  /* USER CODE END EndPoint_Configuration */
  /* USER CODE BEGIN EndPoint_Configuration_MSC */
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData, MSC_EPIN_ADDR, PCD_SNG_BUF, 0xD4);
  HAL_PCDEx_PMAConfig((PCD_HandleTypeDef*)pdev->pData, MSC_EPOUT_ADDR, PCD_SNG_BUF, 0x94);
