...
/* USER CODE BEGIN PV */
static int32_t ProcessStatus = 0;
/* USER CODE END PV */
...
static void GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, LED4_Pin|LED3_Pin, GPIO_PIN_SET);
...
/* USER CODE BEGIN 4 */
/**
  * @brief  This function is executed in case of error occurrence in FATFS_Process function.
  * @retval None
  */
